...
impl Application {
    ...
    fn setup_widgets(&self) {
        let builder = gtk::Builder::from_resource("/me/idlesong/myeditor/shortcuts.ui");
    ...
    fn setup_gactions(&self) {
        ...
        action!(
            ...
            clone!(@weak self.window.widget as window => move |_, _| {
                let builder = gtk::Builder::from_resource("/me/idlesong/myeditor/about_dialog.ui");
    ...
    fn setup_css(&self) {
        ...
        gtk::CssProvider::load_from_resource(&p, "/me/idlesong/myeditor/style.css");
